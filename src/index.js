  ...
  return c.json({
    ...
    docs: {
      body: {
        ...
        fields: 'array (default ["name","address","phone","rating"]) - Data fields',
      ...
      example: {
        ...
        total: 5,
        fields: ['name', 'address', 'phone', 'rating', 'reviews', 'serviceOptions', 'accessibility'],
        maxReviews: 10,
        scrollDelay: 800,
        scrollDistance: 400,
        clickDelay: 300,
...
serve({ fetch: app.fetch, port: PORT }, () => {
  ...
  console.log(`  -d '{"query":"restoran padang jakarta","total":3,"fields":["name","address","phone","rating","reviews"],"maxReviews":5}'`);
  console.log('');
});
