...
export const SELECTORS = {
  ...
  placeReviewCount: 'div.F7nice span[aria-label*="ulasan"], div.F7nice span[aria-label*="review"]',
  ...
  // Hours
  hoursButton: 'div[data-hide-tooltip-on-mouse-move] button[jsaction*="pane.openhours"]',
  ...
  reviewMoreButton: 'button[aria-label="Selengkapnya"], button[aria-label*="More"]',

  // Sort reviews
  reviewSortButton: 'button[data-value*="sort"], button[aria-label*="Urutkan"], button[aria-label*="Sort"]',
  ...
  highlightsSection: 'div[aria-label*="Keunggulan"], div[aria-label*="Highlights"]',
};

export const FIELD_LABELS = {
  // Service options
  serviceOptions: [
    'Dine-in', 'Takeout', 'Delivery', 'Drive-through', 'Curbside pickup',
    'No-contact delivery', 'Dine in', 'Layanan pesan-antar', 'Makan di tempat',
    'Bawa pulang', 'Pesan antar', 'Antar ke mobil', 'Tidak kontak saat pengiriman'
  ],

  // Accessibility
  accessibility: [
    'Tempat parkir', 'Parkir', 'Akses kursi roda', 'Parkir kursi roda',
    'Toilet kursi roda', 'Tempat duduk kursi roda', 'Wheelchair-accessible',
    'Wheelchair accessible', 'Accessible parking', 'Accessible entrance',
    'Accessible restroom', 'Accessible seating', 'Aksesibilitas'
  ],

  // Highlights / Amenities
  highlights: [
    'Tempat ramai', 'Cocok untuk', 'Suasana', 'Layanan', 'Pembayaran',
    'Perencanaan', 'Untuk anak', 'Keunggulan', 'Live music', 'Musik langsung',
    'Ramah anak', 'Cocok untuk grup', 'Ramah hewan peliharaan', 'Parkir gratis'
  ],

  // Food options
  foodOptions: [
    'Makanan', 'Menu', 'Pilihan makanan', 'Vegetarian', 'Vegan',
    'Halal', 'Junk food', 'Dessert', 'Minuman', 'Sarapan',
    'Makan siang', 'Makan malam', 'Pilihan sehat'
  ],

  // Offerings
  offerings: [
    'Penawaran', 'Offering', 'Alkohol', 'Bir', 'Koktail', 'Kopi',
    'Teh', 'Minuman beralkohol', 'Happy hour', 'Pemesanan meja'
  ]
};
